...
function AuthLayout() {
  return (
    <main className="flex items-center justify-center bg-bg h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 w-3/5 h-4/5 rounded-xl bg-white">
        {/* Seccion izquierda */}
        <div className="flex flex-col justify-center px-10 gap-8 rounded-xl bg-primary text-white">
          {/* Marca */}
