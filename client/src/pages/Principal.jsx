            ...
            <header className='flex'>
                ...
                <div className='flex'>
                    {user ? (
                        ...
                        <Link className='btn btnLogin' to="/login">Log in or register</Link>
                    )}
                    {shoppingContext &&
                    ...
                    {showOptionsUser && (
                        ...
                        >
                            ...
                            {user.role === "client" && <Link to="/publishProduct/0">Publish</Link>}
                            {user.role === "client" && <Link to="/editSales">Edit Listings</Link>}
                            {user.role === "client" && <Link to="/profileSales">Sold Items</Link>}
                            {user.role === "client" && <Link to="/profilePurchases">My Purchases</Link>}
